...
from ciscode import readers, writers
...
def main(
    data_dir: str = "data", output_dir: str = "outputs", name: str = "pa3-debug-a"
):
    ...
    # Read inputs
    cal_body = readers.Problem3BodyA(data_dir / f"Problem3Body{name}.txt")
    log.debug("Problem 1")
    C = np.empty((cal_readings.N_marker))
